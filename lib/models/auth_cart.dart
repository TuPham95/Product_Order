...
class Cart {
  ...
  factory Cart.fromJson(Map<String, dynamic> json){
    ...
    return Cart(id: json['id'].toString(), userId: json['userId'].toString(), date: json['date'], products: products,);
  }
}
class Product{
  ...
  factory Product.fromJson(Map<String , dynamic> json){
    return Product(productId: json['productId'].toString(), quantity: json['quantity'].toString());
  }
}